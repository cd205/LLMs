...
xsum_dataset['train'].select(range(10))

# COMMAND ----------

xsum_dataset['train'].features['summary']
...
# Apply to 1 article
summarizer(xsum_sample["document"][2])
...
t5_small_pipeline(
    "translate English to Italian: Existing, open-source (and proprietary) models can be used out-of-the-box for many applications."
)
