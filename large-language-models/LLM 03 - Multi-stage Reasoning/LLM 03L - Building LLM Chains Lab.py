...
import os
os.environ["HUGGINGFACEHUB_API_TOKEN"] = "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"
...
# TODO
text_splitter =  CharacterTextSplitter(chunk_size=2048, chunk_overlap=256) 
