...
dascie.run(
    "construct a graph showing the performance of the Mercedes AMG F1 team in 2020 and do some analysis. You need to plot your results."
)
...
dascie.run(
    "Do a PCA plot of the data showing a scatter plot of the 2 most significant PCA components, colour the points by salery where high salary is a dark color and low salaries are in light colours"
)
